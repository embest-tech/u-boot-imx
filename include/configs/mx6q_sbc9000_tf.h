 ...
 *
 * Configuration settings for the MX6Q SBC9000 Freescale board.
 *
...
#define	CONFIG_EXTRA_ENV_SETTINGS \
		...
		"bootargs_mmc=setenv bootargs ${bootargs} " \
			...
			"${dispmode}\0" \
		"bootcmd_mmc=run bootargs_base bootargs_mmc;mmc dev 0;" \
			"mmc read ${loadaddr} 0x800 0x2000;bootm\0" \
		"bootcmd=run bootcmd_mmc\0" \
		"clearenv=mmc dev 1; mmc erase 0x600 0x10;" \
