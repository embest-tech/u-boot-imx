/*
 * Copyright (C) 2011-2012 Embest Tech, Inc.
 *
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"ethprime=FEC0\0"					\
                ...
                "bootargs=console=ttymxc1,115200 init=/init rw video=mxcfb0:dev=hdmi,1920x1080M@60,if=RGB24 fbmem=10M vmalloc=400M androidboot.console=ttymxc1 "\
