...
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "i.mx6q sbc9000"
...
#define CONFIG_ANDROID_RECOVERY_BOOTCMD_MMC  \
	"run bootargs_android_recovery; booti mmc1 recovery"
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootcmd=run mmcargs;booti mmc1\0" \
        "bootargs_android_recovery=setenv bootargs console=${console},${baudrate} "\
				"${mmcroot} " \
            	"${dispmode} \0" \
...
#define CONFIG_SYS_PROMPT		"MX6Q SBC9000 U-Boot > "
